...
Абсолю́тная величина́, или мо́дуль, числа {\displaystyle x}x (в математике) — неотрицательное число, которое, неформально говоря, обозначает расстояние между началом координат и x, обозначается |x|

...
Но вот незадача, при вводе значений в поле вызывается эта функция и её вызов приводит к ошибке: ReferenceError: i is not defined. Поправьте написанный код функции так, чтобы ошибка больше не проявилась.
 i было let, в этом и была ошибка
 */